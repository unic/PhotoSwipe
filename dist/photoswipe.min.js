...
var b=document.elementFromPoint(jb.x,jb.y),c=!1;b;)b.className&&b.className.indexOf("__caption")>-1&&(c=!0),b=b.parentNode;if(!c){if(
// END IMPORTANT! Manual change - Marcin Borowski - RWRD-847
a.preventDefault(),F){var d=e.arraySearch(lb,a.pointerId,"id");if(d>-1){var f=lb[d];f.x=a.pageX,f.y=a.pageY}}if(U){var g=Lb(a);if(fa||X||_)$=g;else if(sb.x!==sa.x*qa)
// if main scroll position is shifted – direction is always horizontal
fa="h";else{var h=Math.abs(g[0].x-jb.x)-Math.abs(g[0].y-jb.y);
// check the direction of movement
Math.abs(h)>=fb&&(fa=h>0?"h":"v",$=g)}}}},
// 
